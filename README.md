...
The SHA256SUM file is provided (update.sh.sha256). If changes are made to the script (update.sh) you must update the SHA256SUM for the script verification. Otherwise the user would need to comment the verification block located at the top of the script, this option is not recommended.
